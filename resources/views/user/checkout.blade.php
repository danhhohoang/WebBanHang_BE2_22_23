                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="checkout__input">
                                ...
                                <input type="text" id="address" name="address" placeholder="Street Address" class="checkout__input__add" required>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                        ...
                        <div class="checkout__order">
                            ...
                            @endif
                            <button id="submit" type="submit" class="site-btn">PLACE
                                ORDER</button>
                        </div>
                    </div>
                    </div>
